...
public class FileUploadController {
    ...
    private static final String DOWNLOAD_DIR = System.getProperty("user.home") + File.separator + "upload_temp";
    ...
    String handleFileUpload(@RequestParam("file") MultipartFile file) {
        if (!file.isEmpty()) {
            try {
                ...
                e.printStackTrace();
                return "File file is failed: " + e.getMessage();
            }
        } else {
            return "File file is failed: File is empty";
        }
    }
}