...
<page:template>
    ...
    <jsp:attribute name="title">Spring MVC DEMO</jsp:attribute>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>Предназначен для всех, во всем мире.
                                Bootstrap - интуитивно простой и в тоже время мощный интерфейсный фрейморк, повышающий
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>AngularJS — JavaScript-фреймворк с открытым исходным кодом. Предназначен для разработки
                                одностраничных приложений. Его цель — расширение браузерных MVC приложений, упрощение
                                тестирования и разработки.</p>
                            <a href="#" class="btn btn-default">Подробнее</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>В HTML5 реализовано множество новых синтаксических особенностей. Например, элементы
                                video, audio и canvas, а также возможность использования SVG и математических
                                формул.</p>
                            <a href="#" class="btn btn-default">Подробнее</a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <a href="portfolio-item.html">
                        <img class="img-responsive img-portfolio img-hover"
                             src="${pageContext.request.contextPath}/resources/images/angularjs.jpg" alt="">
                    </a>
                </div>
                <div class="col-md-4 col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>Смотрите примеры в действии, а код и описание читайте на <a href="http://javastudy.ru">javastudy.ru</a>
                    </p>
                </div>
                <div class="col-md-6">
            ...
            <c:url value="/interceptorCall/subLevel" var="interceptor"/>
            ...
            <div class="well">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a class="btn btn-lg btn-default btn-block" href="${interceptor}">Вызов перехватчика</a>
                    </div>
                </div>
            </div>
